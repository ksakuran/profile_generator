...
rl.question("'What's your name? Nicknames are also acceptable :) :", (answer1) => {
  console.log(`Thank you for your valuable feedback: ${answer1}`);rl.question("What's an activity you like doing? ", (answer2) => {
        ...
        rl.question("What's your favourite thing to eat for that meal? ", (answer5) => {
          ...
          rl.question("Which sport is your absolute favourite? ", (answer6) => {
            ...
            rl.question("What is your superpower? In a few words, tell us what you are amazing at! ", (answer7) => {
              ...
              console.log("  ");
              process.stdout.write(`${answer1} loves listening to ${answer3} while ${answer2}, \ndevouring ${answer5} for ${answer4}, \nprefers ${answer6} over any other sport,\nand is amazing at ${answer7}.`)
              console.log("\n");
              rl.close();
            });
